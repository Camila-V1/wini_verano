...
class CSmemoria{
	...
	void ImprimirDireccionVertical(int d, TColor FormColor, TCanvas *Canvas,int posX,int posY);
	void ImprimirDireccionHorizontal(int d, TColor FormColor, TCanvas *Canvas, int &posX, int posY);
	void ImprimirP_DE_A_A_B(TColor FormColor, TCanvas *Canvas,int posX,int posY,int a , int b);
	int leng(int i);
    void sumarValorDesdeDireccion(int dir, const string& id, int valor);
       void MostrarMemoriaDesplazada2(TColor FormColor, TCanvas *Canvas, int posX,
